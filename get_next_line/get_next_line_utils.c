...
/*   Updated: 2020/11/18 11:48:48 by skotoyor         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t	ft_strlen(char *s)//この関数なくてもok
{
	size_t i;
...
char	*ft_strnjoin(char *s1, char *s2, size_t len_s2)// len_s2 is like n
{
	char *ret;
	size_t len_s1;
	size_t i;
